...
class ListItem extends Component {
  ...
  handleMove = (direction) => {
    ...
    if (direction === "l") {
      newSlideNumber =
        this.state.slideNumber === 0 ? 5 : this.state.slideNumber - 1;
    } else {
      newSlideNumber =
        this.state.slideNumber === 5 ? 0 : this.state.slideNumber + 1;
    }
          ...
          {this.state.open && (
            <div className="slider">
              ...
              <FontAwesomeIcon
                ...
                className="arrow"
                onClick={() => this.handleMove("l")}
              />
              <div className="sliderWrapper">
                <img
                  src={this.state.photos[this.state.slideNumber].src}
                  alt=""
                  className="sliderImg"
                />
              </div>
...
export default withParams(ListItem);
